...
public class Main : MonoBehaviour {
	...
	void Update () {
		...
		if(Input.GetKeyUp("c")){
			searchForFiles ("C:/Users/Jonas/Music");
	...
	void searchForFiles(string baseDirectory){
		...
		foreach(string mp3FilePath in Directory.GetFiles(baseDirectory, "*.mp3"))
            { 
             Mp3ID3 id3 = new Mp3ID3(mp3FilePath);
			 Debug.Log(id3.Title);
             Debug.Log(id3.Album);
             Debug.Log(id3.Artist);
             Debug.Log(id3.Genre);
		}
